...
- Instancing recap: need instancing to avoid the multiple call performance overhead stacking up by forcing the GPU to take over instead of the CPU sending instructions to the GPU for every draw. 