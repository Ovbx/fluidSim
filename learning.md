...
- While adding the Staggered Grid and fluidSolver over to the main source file, I figured that the program just crashes. Stepping over from a breakpoint set at fluidSolver just crashes the program.
